...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Account Information">
    ...
    <script class="u-script" type="text/javascript" src="{{ asset('intlTelInput/intlTelInput.min.js') }}" defer=""></script>
    <script class="u-script" type="text/javascript" src="{{ asset('intlTelInput/utils.js') }}" defer=""></script>
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en">
    ...
    <header class="u-clearfix u-header u-header" id="sec-18a8" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1" data-responsive-from="SM">
          ...
          <div class="u-custom-menu u-nav-container" style="color: white">
            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-custom-color-6 " href="home.html" style="padding: 10px 20px;">Home</a>
    </li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-custom-color-6" href="about.html" target="_blank" style="padding: 10px 20px;">About</a>
    </li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-custom-color-6" href="contact.html" target="_blank" style="padding: 10px 20px;">Contact</a>
    </li></ul>
          </div>
    ...
    <section class="u-clearfix u-section-1" id="sec-3cb5">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-default u-text-1">Account Information</h2>
        <div class="u-form u-form-1">
          {{-- <form action="{{ route('register') }}" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px;">
            @csrf
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-1">
                <label for="name-1" class="u-label">First Name</label>
                <input type="text" placeholder="Enter your First Name" id="name-1" name="name-1" class="u-input u-input-rectangle u-radius u-input-1" required>
            </div>
            <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-2">
                <label for="name-2" class="u-label">Last Name</label>
                <input type="text" placeholder="Enter your Last Name" id="name-2" name="name-2" class="u-input u-input-rectangle u-radius u-input-2" required>
            </div>
            <div class="u-form-group u-form-phone u-form-group-3">
                <label for="phone" class="u-label">Phone</label>
                <div class="iti iti--allow-dropdown">
                    <input type="tel" placeholder="0100 123 4567" id="phone" name="phone" class="u-input u-input-rectangle u-radius u-input-3" required data-country-code="eg">
                </div>
            </div>
            <div class="u-form-email u-form-group">
                <label for="email" class="u-label">Email Address</label>
                <input type="email" placeholder="Enter a valid email address" id="email" name="email" class="u-input u-input-rectangle u-radius u-input-4" required>
            </div>
            <div class="u-form-group u-form-group-5">
                <label for="password" class="u-label">Password</label>
                <input type="password" placeholder="Enter your password" id="password" name="password" class="u-input u-input-rectangle u-radius u-input-5" required maxlength="30">
            </div>
            <div class="u-form-group u-form-group-6">
                <label for="password_confirmation" class="u-label">Confirm Password</label>
                <input type="password" placeholder="Confirm your password" id="password_confirmation" name="password_confirmation" class="u-input u-input-rectangle u-radius u-input-6" required maxlength="30">
            </div>
            <div class="u-align-left u-form-group u-form-submit">
                <button type="submit" class="u-btn u-btn-round u-btn-submit u-button-style u-custom-color-6 u-radius u-btn-1">Register</button>
            </div>
            <p class="u-text u-text-default u-text-2" style="padding-left: 25%">Have an account? </p>
            <p class="u-text u-text-custom-color-6 u-text-default u-text-3">
              <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-custom-color-6 u-btn-4" data-href="login">Sign In</a>
            </p>
        </form> --}}
         <form action="{{ route('store') }}" method="POST" style="padding: 10px;">
                @csrf
                <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-1">
                    <label for="first_name" class="u-label">First Name:</label>
                    <input type="text" placeholder="Enter your First Name" id="first_name" name="first_name" value="{{ old('first_name') }}" class="u-input u-input-rectangle u-radius u-input-1 @error('first_name') is-invalid @enderror" required>
                ...
                <div class="u-form-group u-form-name u-form-partition-factor-2 u-form-group-2">
                    ...
                    <input type="text" placeholder="Enter your Last Name" id="last_name" name="last_name" value="{{ old('last_name') }}" class="u-input u-input-rectangle u-radius u-input-2 @error('last_name') is-invalid @enderror" required>
                ...
                <div class="u-form-email u-form-group">
                  <label for="email" class="u-label">Email Address</label>
                  <input type="email" placeholder="Enter a valid email address" id="email" name="email" value="{{ old('email') }}" class="u-input u-input-rectangle u-radius u-input-4 @error('email') is-invalid @enderror" required>
                    @if ($errors->has('email'))
            ...
            <div class="u-form-group u-form-group-6">
                <label for="password_confirmation" class="u-label">Confirm Password</label>
                <input type="password" placeholder="Confirm your password" id="password_confirmation" name="password_confirmation" class="u-input u-input-rectangle u-radius u-input-6 @error('password_confirmation') is-invalid @enderror" required maxlength="30">
                @if ($errors->has('password_confirmation'))
                    <span class="text-danger">{{ $errors->first('password_confirmation') }}</span>
                @endif
              </div>
            <div class="u-align-left">
              <button type="submit" class="u-custom-color-6 u-radius u-btn-1">Register</button>
            </div>
                <p class="u-text u-text-default u-text-2" style="padding-left: 37%">Have an account? </p>
                <p class="u-text u-text-custom-color-6 u-text-default u-text-3" style="padding-left: 39%">
                <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-custom-color-6 u-btn-4" data-href="login">Sign In</a>
            </p>
            </form>
